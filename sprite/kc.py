...
cave = pygame.image.load('background.png').convert_alpha()
test_font = pygame.font.Font('Pixeltype.ttf', 50)
roock = pygame.image.load('longer rock platform.png').convert_alpha()
rock = pygame.image.load('rock platform.png').convert_alpha()
ground = pygame.image.load('ground.png').convert_alpha()
boy = pygame.image.load('boy.png').convert_alpha()
flag = pygame.image.load('Finish_flag.png').convert_alpha() # changed from 'finish_flag.png' to 'Finish_flag.png'
boy_y = 560
boy_vel_x = 0
boy_vel_y = 0
jumping = True
